...
const Question = () => {
  ...
  const handleClick = (response) => {
    ...
    history.push(parsedIdx >= numberOfQuestions ? '/score' : `/question/${nextIdx}`);
  ...
  return (
    <Row className="d-flex flex-column align-items-center">
      ...
      <Row>
        <Button color="primary" className="mr-3" onClick={() => handleClick("True")}>True</Button>
        <Button color="danger" onClick={() => handleClick("False")}>False</Button>
      </Row>
    </Row>
  )
}
